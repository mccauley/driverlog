package com.mccauley.driverlog.util
...
object LocationHelper {
  ...
  def isBetterLocation(location: Location, currentBestLocation: Location): Boolean = {
    ...
    val isFromSameProvider = isSameProvider(location.getProvider(), currentBestLocation.getProvider())
  ...
  def isSameProvider(provider1: String, provider2: String): Boolean = {
    if (provider1 == null) {
